...
export const ja: Record<StringKey, string> = {
  ...
  "cres.meaning": "見分けられた、いちばんうすい模様です。数値が大きいほど良好です。",
  "cres.thresholdMeaning":
    "見分けるのに必要だったコントラストの量です。小さいほど良好です。",

  "cres.about1":
    "視力検査とは別の力です。視力は小さな文字、こちらはうすい模様を見分ける力です。",
  "cres.about2": "夜の運転、霧の中、人の顔、うすい文字などの見やすさに関わります。",
  "cres.about3":
    "画面は較正されていないので、比べるのは同じ端末での自分の記録だけにしてください。",
  "cres.about4": "数週間かけて下がり続けるようなら、一度眼科で診てもらってください。",
  ...
  "ctip.glare.b": "画面とメガネをきれいに。照明が画面に映り込まない向きにしましょう。",
